...
void AI_Run(const int8_t *mel_feature, int *pred_class, float *confidence) {
    ...
    // ========== 4. 反量化得到置信度 ==========
    // ESP-DL 使用 exponent 量化方式：real_value = int_value * 2^exponent
